...
export type Ticket = {
  ...
  externalUserMobile: string
  currentAssigneeId: number
  currentTeamId: number
  conversationId: number
  replyCount: number
  satisfied?: number
  satisfiedRemark: string
  tags: string
  remark: string
  createdAt: number
  updatedAt: number
...
export function fetchTicketCategory(id: number) {
  return request<TicketCategory>(`/api/console/ticket-category/${id}`)
}

export function fetchTicketCategoryTree() {
  return request<TicketCategory[]>("/api/console/ticket-category/tree")
}
...
export function updateTicketCategorySort(ids: number[]) {
  return request<void>("/api/console/ticket-category/update_sort", {
    method: "POST",
    body: JSON.stringify(ids),
  })
}
...
export function fetchTickets(
  ...
  return request<PageResult<Ticket>>(
    `/api/console/ticket/list${toQueryString(query)}`
  )
}

export function fetchTicketDetail(id: number) {
  return request<Ticket>(`/api/console/ticket/${id}`)
}

export function createTicket(payload: CreateTicketPayload) {
  return request<Ticket>("/api/console/ticket/create", {
    method: "POST",
    body: JSON.stringify(payload),
  })
}
...
export function deleteTicket(id: number) {
  return request<void>("/api/console/ticket/delete", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function assignTicket(payload: AssignTicketPayload) {
...
export function fetchTicketReplies(ticketId: number) {
  return request<PageResult<TicketReply>>(
    `/api/console/ticket-reply/list?ticketId=${ticketId}`
  )
}

export function createTicketReply(payload: CreateTicketReplyPayload) {
  return request<TicketReply>("/api/console/ticket-reply/create", {
    method: "POST",
    body: JSON.stringify(payload),
  })
}

export function updateTicketReply(id: number, content: string) {
  return request<void>("/api/console/ticket-reply/update", {
    method: "POST",
    body: JSON.stringify({ id, content }),
  })
}

export function deleteTicketReply(id: number) {
  return request<void>("/api/console/ticket-reply/delete", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}
...
export function fetchTicketComments(ticketId: number) {
  return request<PageResult<TicketComment>>(
    `/api/console/ticket-comment/list?ticketId=${ticketId}`
  )
}

export function createTicketComment(payload: CreateTicketCommentPayload) {
  return request<TicketComment>("/api/console/ticket-comment/create", {
    method: "POST",
    body: JSON.stringify(payload),
  })
}

export function deleteTicketComment(id: number) {
  return request<void>("/api/console/ticket-comment/delete", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}
...
export function fetchTicketAssignments(ticketId: number) {
  return request<PageResult<TicketAssignment>>(
    `/api/console/ticket-assignment/list?ticketId=${ticketId}`
  )
}
