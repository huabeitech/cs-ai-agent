          ...
          <div className="flex min-h-0 flex-1 flex-col gap-4 lg:flex-row">
            ...
            <div className="hidden shrink-0 lg:flex lg:items-start">
              <Button
                variant="outline"
                size="icon"
                className="mt-4 size-7 rounded-full shadow-sm"
            ...
            <div
              className={`min-w-0 shrink-0 overflow-hidden transition-[width] duration-200 ${
                rightPanelCollapsed ? "lg:w-0" : "lg:w-[380px]"
              }`}
            >
              <div className={`space-y-4 lg:h-full lg:overflow-y-auto lg:pr-1 ${rightPanelCollapsed ? "lg:opacity-0" : ""}`}>
                <Card>
                  <CardHeader>
