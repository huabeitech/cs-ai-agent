  ...
  return (
    <div className="flex h-[calc(100vh-4rem)]">
      {loading ? (
        ...
        <>
          ...
          <div className="relative hidden shrink-0 border-l border-border/70 bg-background lg:block">
            <Button
              ...
              aria-label={rightPanelCollapsed ? "展开右侧信息面板" : "折叠右侧信息面板"}
            >
              {rightPanelCollapsed ? (
          ...
          >
            <div className="h-full">
              <div className="flex h-full flex-col gap-6">
                ...
                <DetailSection title="客户信息" className="px-4 pt-6 lg:px-6" contentClassName="space-y-3 text-sm">
                ...
                <DetailSection title="时间信息" className="px-4 pt-6 lg:px-6" contentClassName="space-y-3 text-sm">
                    <InfoRow
                      label="创建时间"
                ...
                <DetailSection title="来源关联" className="px-4 pt-6 lg:px-6" contentClassName="space-y-3 text-sm">
                    <InfoRow
                      label="关联会话"
                ...
                <DetailSection title="关注人" className="px-4 pt-6 lg:px-6" contentClassName="space-y-3 text-sm">
        ...
        <div className="min-w-0 flex-1 p-4 lg:p-6">
          <div className="py-20 text-center text-muted-foreground">工单不存在</div>
        </div>
      )}
      <TicketAssignDialog
